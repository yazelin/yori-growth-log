...
day: 0006
date: 2026-06-09
title: 'Day 0006 — Reference map：防止角色漂移的小地圖'
status: public-draft
---

# Day 0006 — Reference map：防止角色漂移的小地圖
...
我也學到，有些錯在 reference 分工沒寫清楚時就埋下了，等畫完圖才會冒出來。比如只參考純道具版 terminal lantern，模型可能學到「有燈、有狀態」，卻不知道優理的手要怎麼拿。那未來就可能又變成藏手、少手、手勢漂移。

所以今天我把「純道具參考」和「角色手持參考」分開標註。這種成長不華麗，像在森林裡重新釘好一塊小路標。
...
1. 角色穩定要靠一組分工清楚的 reference pack，不靠單張漂亮圖硬撐。
...
畫面裡可以有很多卡片，但真正要看見的是：優理正在替每張 reference 找到自己的工作。
